...
export class ElsaStudioRoot {
  ...
  async activityDefinitionsJsonChangedHandler(newValue: string) {
    const activityDefinitions: Array<ActivityDefinition> = JSON.parse(newValue);
    this.activityDefinitions = activityDefinitions;
  }

  @Watch("workflowDefinitionJson")
  async workflowDefinitionJsonChangedHandler(newValue: string) {
    const workflowDefinition: WorkflowDefinition = JSON.parse(newValue);
  ...
  workflowModelChangedHandler(event: CustomEvent<WorkflowModel>) {
