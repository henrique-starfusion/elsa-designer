...
export class ElsaWorkflowInstanceJournal {
  ...
  async workflowInstanceJsonChangedHandler(newValue: WorkflowInstance) {
    const workflowInstance: WorkflowInstance = newValue;
  ...
  async componentWillLoad() {
    await this.workflowInstanceJsonChangedHandler(this.workflowInstance);
  }
