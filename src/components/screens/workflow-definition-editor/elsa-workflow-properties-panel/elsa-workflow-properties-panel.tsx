...
import { ElsaWorkflowDefinitionEditorScreen } from '../elsa-workflow-definition-editor-screen/elsa-workflow-definition-editor-screen';
...
export class ElsaWorkflowPropertiesPanel {
  ...
  async loadPublishedVersion() {
    ...
    const publishedDefinition: WorkflowDefinitionSummary = workflowDefinition.isPublished ? workflowDefinition : ElsaWorkflowDefinitionEditorScreen.createWorkflowDefinition();
...
Tunnel.injectProps(ElsaWorkflowPropertiesPanel, ['culture']);
