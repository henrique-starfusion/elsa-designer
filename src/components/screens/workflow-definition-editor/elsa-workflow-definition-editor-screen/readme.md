...
| ------------------------- | ---------------------- | ----------- | --------------- | ----------- |
| `activityDefinitionsJson` | `activity-definitions` |             | `string`        | `undefined` |
...
| `workflowDefinitionJson`  | `workflow-definition`  |             | `string`        | `undefined` |
...
| ----------------------------- | ----------- | --------------------------------- |
| `workflow-definition-changed` |             | `CustomEvent<WorkflowDefinition>` |
