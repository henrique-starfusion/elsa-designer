  ...
  render() {
    ...
    return (
      <Host>
        ...
        <section
          class={`${this.expanded ? '' : 'elsa-hidden'} elsa-absolute elsa-top-4 elsa-right-0 elsa-bottom-0 elsa-overflow-hidden`}
          aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
          <div class="elsa-fixed elsa-inset-0 elsa-overflow-hidden">
            <div class="elsa-absolute elsa-inset-0" aria-hidden="true"/>
            <div
              class="elsa-absolute elsa-top-20 elsa-inset-y-0 elsa-right-2 elsa-bottom-2 max-elsa-w-full elsa-flex">
              <div
                ref={el => this.el = el}
