  ...
  renderModal() {
    return (
      <Host class={{ 'hidden': !this.isVisible, 'elsa-block': true }}>
        <div class="elsa-fixed elsa-inset-0 elsa-overflow-y-auto elsa-z-modal">
          <div
            ...
            <div ref={el => this.modal = el}
              ...
              class="hidden elsa-inline-block elsa-bg-white elsa-rounded-lg elsa-text-left elsa-overflow-visible elsa-shadow-xl elsa-transform elsa-transition-all sm:elsa-my-8 sm:elsa-align-top sm:elsa-max-w-4xl sm:elsa-w-full"
