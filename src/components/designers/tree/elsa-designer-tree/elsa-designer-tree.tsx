...
export class ElsaWorkflowDesigner {
  ...
  @Event({
    eventName: 'workflow-model-changed',
    bubbles: true,
    composed: true,
    cancelable: true
  }) workflowModelChanged: EventEmitter<WorkflowModel>;
  ...
  handleSelectedActivityIdsChanged(newValue: Array<string>) {
    //console.debug('handleSelectedActivityIdsChanged', newValue);
    const ids = newValue || [];
  ...
  async showActivityEditorInternal(activity: ActivityModel, animate: boolean) {
    console.debug('showActivityEditorInternal', activity);
  ...
  updateWorkflowModel(model: WorkflowModel, emitEvent: boolean = true) {
    ...
    if (emitEvent)
      this.workflowModelChanged.emit(model);
  }
  ...
  async addActivity(activity: ActivityModel, sourceActivityId?: string, targetActivityId?: string, outcome?: string) {
    ...
    console.debug('addActivity', activity, this.workflowModel)
  ...
  onWorkflowExecuted = () => {
    ...
    console.debug('onWorkflowExecuted', activity);
  }
